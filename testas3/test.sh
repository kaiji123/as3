...
# It will load the device opsysmem
# Then create a device file,
# Write a message in it,
# Read the message,
# Verify that it is the same message and
# Unload the module
# There are a lot of things that it does not check
# For example that your device works correctly
# when writing/reading multiple messages
